...
async def main():
    ...
    app.add_handler(CommandHandler(["balance", "yue"], balance_cmd))
    app.add_handler(MessageHandler(filters.TEXT & filters.Regex("^余额$"), balance_cmd))
    app.add_handler(CommandHandler(["walletlog"], walletlog_cmd))
    app.add_handler(CommandHandler(["recharge"], recharge_cmd))
    app.add_handler(CommandHandler(["withdraw"], withdraw_cmd))
    app.add_handler(CommandHandler(["rebatelog"], rebatelog_cmd))
    app.add_handler(CommandHandler(["inviteinfo"], inviteinfo_cmd))
